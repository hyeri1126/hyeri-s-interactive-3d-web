...
이 프로젝트를 통해 3D 웹 개발의 전체 파이프라인을 경험하며 평소 궁금했던 3D 인터랙티브 웹 제작에 대한 궁금증을 해소할 수 있었으며 프론트엔드 개발자로서 기술 역량을 확보하고 더 넓은 시야를 가지게 되었습니다.
특히, 생애 처음으로 c4D를 접하면서 3D 모션 그래픽을 제작하는 경험은 디자이너의 관점을 이해하는데 도움이 되었으며, Three.js를 통해 모션 그래픽을 웹에 구현하는 과정은 평소 어려웠떤 Three.js 라이브러리를 깊이 이해하는데 도움이 되었습니다. 
이번 프로젝트는 평소 갈망했던 3D 웹 개발의 시작점이라고 생각하며 앞으로도 꾸준히 공부하여 다양한 프로젝트에 이를 적용시키고자 합니다. 
